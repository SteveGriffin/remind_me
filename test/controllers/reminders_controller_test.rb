...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { message: @reminder.message, phone: @reminder.phone, reminder_time: @reminder.reminder_time }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { message: @reminder.message, phone: @reminder.phone, reminder_time: @reminder.reminder_time }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
